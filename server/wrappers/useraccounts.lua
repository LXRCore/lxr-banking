--[[
    ...
    🐺 LXR Banking — User Account Wrapper (Current & Savings)
    ═══════════════════════════════════════════════════════════════════════════════
    ██╗     ██╗  ██╗██████╗        ██████╗  █████╗ ███╗   ██╗██╗  ██╗██╗███╗   ██╗ ██████╗
    ██║     ╚██╗██╔╝██╔══██╗      ██╔══██╗██╔══██╗████╗  ██║██║ ██╔╝██║████╗  ██║██╔════╝
    ██║      ╚███╔╝ ██████╔╝█████╗██████╔╝███████║██╔██╗ ██║█████╔╝ ██║██╔██╗ ██║██║  ███╗
    ...
    🐺 LXR Core - Banking System | Server - User Account Wrappers
...
RegisterServerEvent('lxr-banking:server:registerCurrentAccount')
AddEventHandler('lxr-banking:server:registerCurrentAccount', function(cid)
...
RegisterServerEvent('lxr-banking:server:registerSavingsAccount')
AddEventHandler('lxr-banking:server:registerSavingsAccount', function(cid)
